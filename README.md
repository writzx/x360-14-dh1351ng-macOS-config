...
### IO Devices
 ...
 - [x] Trackpad
	> VoodooI2C.kext + VoodooRMI.kext (or optionally VoodooI2C.kext + VoodooI2CHID.kext if disabling touchscreen [^3])  
	> SSDT-XOSI + _OSI rename patch  
	> GPIO pin patch (`GPDI` replace from `0x04040003` to `0x04070003`): >> **DO NOT APPLY if using the _`GPLI replace`_ patch from touchscreen fixes below** [^4]  
 ...
 - [x] Touchscreen
	...
	> GPIO pin patch (GPLI replace from `0x04040007` to `0x04070007`): >> **DO NOT APPLY if using the _`GPDI replace`_ patch from trackpad fixes above** [^4]  
	...
	> 			<integer>0</integer>
	> 			<key>Comment</key>
	> 			<string>Rename TPL1._STA to TPL1.XSTA</string>
	> 			<key>Count</key>
	> 			<integer>0</integer>
	> 			<key>Enabled</key>
	> 			<true/>
 ...
 - [x] NVMe devices >> ***WORKS - USB fixes, WiFi fixes, kext conflict fixes, etc.*** [^5]
