 ...
 *
 * Disassembly of SSDT-4-866E.aml, Thu Jan 02 17:48:09 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000048FE (18686)
 *     Revision         0x01
 *     Checksum         0xBE
 *     OEM ID           "HPQOEM"
 *     OEM Table ID     "866E    "
...
{
    External (CCSR, IntObj)
    External (CMRS, IntObj)
    External (GADD, MethodObj)    // 0 Arguments
    External (GBAT, MethodObj)    // 1 Arguments
    External (GBCC, MethodObj)    // 0 Arguments
    External (GBCO, MethodObj)    // 0 Arguments
    External (GHKF, MethodObj)    // 0 Arguments
    External (GHKS, MethodObj)    // 0 Arguments
    External (GTCS, MethodObj)    // 0 Arguments
    External (GTDH, MethodObj)    // 2 Arguments
    External (GWDI, MethodObj)    // 0 Arguments
    External (HODW, MethodObj)    // 1 Arguments
    External (OSYS, IntObj)
    External (SAST, MethodObj)    // 0 Arguments
    External (SBCC, MethodObj)    // 1 Arguments
    External (SBCO, MethodObj)    // 1 Arguments
    External (SHKF, MethodObj)    // 1 Arguments
    External (SHKS, MethodObj)    // 1 Arguments
    External (SNDD, MethodObj)    // 1 Arguments
    External (SSMP, FieldUnitObj)
    External (STCS, MethodObj)    // 1 Arguments
    External (STDH, MethodObj)    // 1 Arguments
    External (SWDS, MethodObj)    // 1 Arguments
    External (TYPC, MethodObj)    // 1 Arguments
    External (VTFT, IntObj)
    ...
    Scope (\_SB)
    {
        ...
        Device (\_SB.WMID)
        {
            ...
            Name (_WDG, Buffer (0x0104)
            {
                ...
                /* 0070 */  0x09, 0xE7, 0x51, 0x33, 0x42, 0x43, 0x3B, 0x00,  // ..Q3BC;.
                /* 0078 */  0xE3, 0x08, 0x8D, 0x98, 0xF4, 0x68, 0x35, 0x4C,  // .....h5L
                /* 0080 */  0xAF, 0x3E, 0x6A, 0x1B, 0x81, 0x06, 0xF8, 0x3C,  // .>j....<
                /* 0088 */  0x42, 0x44, 0x16, 0x00, 0x46, 0x97, 0xEA, 0x14,  // BD..F...
            ...
            OperationRegion (HNVS, SystemMemory, 0x9BA34000, 0x000002E8)
            ...
            Name (FSB3, Zero)
            Name (FSB4, Zero)
            OperationRegion (OHFL, SystemMemory, 0x9BA3BF98, 0x0000001E)
            ...
            {
                Store (Arg0, CMSI) /* \_SB_.WMID.CMSI */
                Store (Arg1, CMSD) /* \_SB_.WMID.CMSD */
            }
            ...
            {
                Store (Arg0, HWCT) /* \_SB_.WMID.HWCT */
                Store (Arg1, HWBC) /* \_SB_.WMID.HWBC */
                If (CondRefOf (\SSMP))
                {
                    Store (0xC3, \SSMP) /* External reference */
                }
                Else
                {
                }
                ...
                {
                    Store (HWRC, RTCC) /* \_SB_.WMID.RTCC */
                }
            ...
            Method (RDCF, 2, Serialized)
            {
                ...
                Switch (Arg0)
                {
                    Case (0x08)
                    {
                        Store (Zero, RTCC) /* \_SB_.WMID.RTCC */
                        Store (Zero, HWRC) /* \_SB_.WMID.HWRC */
                        Store (Package (0x03)
                            {
                                Zero, 
                                0x04, 
                    ...
                    Case (0x1B)
                    {
                        ...
                        {
                            Store (0x04, RTCC) /* \_SB_.WMID.RTCC */
                        }
                        Else
                        {
                            Store (Zero, RTCC) /* \_SB_.WMID.RTCC */
            ...
            Method (GWSD, 0, NotSerialized)
            {
                ...
                Store (HWQ1, BUFS) /* \_SB_.WMID.GWSD.BUFS */
                Return (Local0)
            }
            ...
            Method (SWSD, 3, NotSerialized)
            {
                ...
                Store (Arg0, HWD1) /* \_SB_.WMID.SWSD.HWD1 */
                Store (Arg1, HWW1) /* \_SB_.WMID.SWSD.HWW1 */
                Store (Arg2, HWW2) /* \_SB_.WMID.SWSD.HWW2 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x10, 0x02)
                Return (Package (0x02)
                {
                    Zero, 
            ...
            Method (GDLC, 0, NotSerialized)
            {
                ...
                Store (HWD1, BUFS) /* \_SB_.WMID.GDLC.BUFS */
                Return (Local0)
            }
            ...
            Method (SDLC, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.SDLC.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x1D, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (GBUS, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GBUS.BUFS */
                Return (Local0)
            }
            ...
            Method (SBUS, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.SBUS.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x1E, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (GTDC, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.GTDC.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x28, One)
                Store (Package (0x03)
                    {
                ...
                Store (HWBF, Local2)
                Store (Local2, BUFS) /* \_SB_.WMID.GTDC.BUFS */
                Return (Local1)
            }
            ...
            Method (GFCC, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GFCC.BUFS */
                Return (Local0)
            }
            ...
            Method (SFCC, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.SFCC.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x29, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (GPES, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GPES.BUFS */
                Return (Local0)
            }
            ...
            Method (SPES, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.SPES.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x2A, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (CSTA, 0, NotSerialized)
            {
                ...
                Store (One, IAOR) /* \_SB_.WMID.IAOR */
                If (CondRefOf (\SSMP))
                {
                    Store (0xC6, \SSMP) /* External reference */
                }
                Else
                {
                }
            ...
            Method (CACT, 1, NotSerialized)
            {
                ...
                Store (0x02, IAOR) /* \_SB_.WMID.IAOR */
                Store (Arg0, CDAT) /* \_SB_.WMID.CDAT */
                If (CondRefOf (\SSMP))
                {
                    Store (0xC6, \SSMP) /* External reference */
                }
                ...
                Store (Zero, CDAT) /* \_SB_.WMID.CDAT */
                Return (Local0)
            }
            ...
            Method (CDAC, 1, NotSerialized)
            {
                ...
                Store (0x03, IAOR) /* \_SB_.WMID.IAOR */
                Store (Arg0, CDAT) /* \_SB_.WMID.CDAT */
                If (CondRefOf (\SSMP))
                {
                    Store (0xC6, \SSMP) /* External reference */
            ...
            Method (CAIP, 1, NotSerialized)
            {
                ...
                Store (0x06, IAOR) /* \_SB_.WMID.IAOR */
                CreateDWordField (Arg0, Zero, CMTK)
                Store (CMTK, CDAT) /* \_SB_.WMID.CDAT */
                Store (Arg0, EHWB) /* \_SB_.WMID.EHWB */
                If (CondRefOf (\SSMP))
                {
                    Store (0xC6, \SSMP) /* External reference */
                }
                ...
                Store (Zero, HWBF) /* \_SB_.WMID.HWBF */
                Return (Local0)
            }
            ...
            Method (GJVS, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GJVS.BUFS */
                Return (Local0)
            }
            ...
            Method (SJVS, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.SJVS.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x35, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (GPST, 0, NotSerialized)
            {
                ...
                Store (BUFS, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x36, One)
                Store (HWBF, BUFS) /* \_SB_.WMID.GPST.BUFS */
                Return (Local0)
            }
            ...
            Method (GBCT, 0, NotSerialized)
            {
                ...
                Store (BUFS, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x37, One)
                Store (HWBF, BUFS) /* \_SB_.WMID.GBCT.BUFS */
                Return (Local0)
            }
            ...
            Method (GBST, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GBST.BUFS */
                Return (Local0)
            }
            ...
            Method (GBMF, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GBMF.BUFS */
                Return (Local0)
            }
            ...
            Method (GTPS, 0, NotSerialized)
            {
                ...
                Store (HWBF, Local1)
                CreateDWordField (Local1, Zero, HWD1)
                Store (HWD1, BUFS) /* \_SB_.WMID.GTPS.BUFS */
                Return (Local0)
            }
            ...
            Method (STPS, 1, NotSerialized)
            {
                Store (Buffer (0x80){}, Local0)
                CreateDWordField (Local0, Zero, HWD1)
                Store (Arg0, HWD1) /* \_SB_.WMID.STPS.HWD1 */
                Store (Local0, HWBF) /* \_SB_.WMID.HWBF */
                GHWI (0x4C, 0x02)
                Return (Package (0x02)
                {
            ...
            Method (WHCM, 2, Serialized)
            {
                ...
                If (LEqual (SNIN, 0x55434553))
                {
                    ...
                    Switch (COMD)
                    {
                        Case (One)
                        {
                            If (LAnd (LGreater (CMTP, Zero), LLessEqual (CMTP, 0x4C)))
                            {
                                ...
                                Else
                                {
                                    ...
                                    Store (RTCC, RTCD) /* \_SB_.WMID.WHCM.RTCD */
                                }
                            }
                        }
                        Case (0x02)
                        ...
                        Case (0x00020002)
                        {
                            Switch (CMTP)
                            {
                                ...
                                {
                                    Store (CSTA (), Local2)
                                    Store (Zero, RTCD) /* \_SB_.WMID.WHCM.RTCD */
                                }
                                Case (0x02)
                                {
                ...
                If (LEqual (RTCD, Zero))
                {
                    Store (DerefOf (Index (Local2, Zero)), RTCD) /* \_SB_.WMID.WHCM.RTCD */
                    If (LEqual (RTCD, Zero))
                    {
            ...
            Method (_WED, 1, NotSerialized)  // _Wxx: Wake Event
            {
                ...
                Else
                {
                    ...
                    If (LNotEqual (WEI2, Zero))
                    {
                        ...
                        Store (WEI1, EVID) /* \_SB_.WMID._WED.EVID */
                        Store (WED1, EVDA) /* \_SB_.WMID._WED.EVDA */
                        Store (Zero, WEI2) /* \_SB_.WMID.WEI2 */
                        Store (Zero, WED2) /* \_SB_.WMID.WED2 */
                        If (LEqual (WEVT, Zero))
                        {
                            Store (One, WEVT) /* \_SB_.WMID.WEVT */
            ...
            Method (STCP, 3, NotSerialized)
            {
                ...
                Store (Arg0, ST01) /* \_SB_.WMID.STCP.ST01 */
                Store (Arg1, ST02) /* \_SB_.WMID.STCP.ST02 */
                Store (Arg2, Local0)
                Store (Zero, Local1)
            ...
            Method (WMBA, 3, NotSerialized)
            {
                ...
                If (LEqual (Arg1, One))
                {
                    ...
                    Store (Zero, Index (DBUF, Local5))
                    Store (DBUF, EHWB) /* \_SB_.WMID.EHWB */
                    Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                    Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                    Store (0xFD, HWBC) /* \_SB_.WMID.HWBC */
                    If (CondRefOf (\SSMP))
                    {
                        Store (0xD7, \SSMP) /* External reference */
                    }
                    Else
                    {
                    }
                ...
                ElseIf (LEqual (Arg1, 0x02))
                {
                    ...
                    Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                    Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                    Store (0xFC, HWBC) /* \_SB_.WMID.HWBC */
                    If (CondRefOf (\SSMP))
                    {
                        Store (0xD7, \SSMP) /* External reference */
                    }
            ...
            Method (WQBC, 1, NotSerialized)
            {
                ...
                Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                Store (0xFE, HWBC) /* \_SB_.WMID.HWBC */
                If (CondRefOf (\SSMP))
                {
                    Store (0xD7, \SSMP) /* External reference */
                }
                ...
                If (LEqual (Zero, HWRC))
                {
                    ...
                    Name (STRB, "                                                                      ")
                    Store (NSTR, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    ...
                    Store (VSTR, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, One))
                    Store (CSTR, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, 0x0A))
                    Store (PBV1, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, 0x0C))
                    Store (PBV2, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, 0x0D))
                    Store (PBV3, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, 0x0E))
                    Store (PBV4, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
                    Store (STRB, Index (BERP, 0x0F))
                    Store (PBV5, BF2S) /* \_SB_.WMID.WQBC.BF2S */
                    Store (BF2S, STRB) /* \_SB_.WMID.WQBC.STRB */
            ...
            Method (WQBD, 1, NotSerialized)
            {
                Acquire (MSMT, 0xFFFF)
                Store (Arg0, Local0)
                Store (Local0, EHWB) /* \_SB_.WMID.EHWB */
                Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                Store (0xF9, HWBC) /* \_SB_.WMID.HWBC */
                Store (0xD7, \SSMP) /* External reference */
                If (LEqual (Zero, HWRC))
                {
                    ...
                    If (LNotEqual (VSTL, Zero))
                    {
                        ...
                        While (LLessEqual (Local4, Local6))
                        {
                            If (LEqual (Local4, Local6))
                            {
                                ...
                                Else
                                {
                                    Store (Local7, CONL) /* \_SB_.WMID.WQBD.CONL */
                                }
                            }
                            Else
                            {
                                Store (0xC8, CONL) /* \_SB_.WMID.WQBD.CONL */
                            }
            ...
            {
                Acquire (MSMT, 0xFFFF)
                Store (Zero, EHWB) /* \_SB_.WMID.EHWB */
                Store (Arg0, Local0)
                Store (Local0, EHWB) /* \_SB_.WMID.EHWB */
                Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                Store (0xFB, HWBC) /* \_SB_.WMID.HWBC */
                If (CondRefOf (\SSMP))
                {
                    Store (0xD7, \SSMP) /* External reference */
                }
                ...
                If (LEqual (Zero, HWRC))
                {
                    ...
                    Store (CNST, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, Zero))
                    Store (CVST, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, One))
                    Store (TSR1, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x0B))
                    Store (TSR2, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x0C))
                    Store (TSR3, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x0D))
                    Store (TSR4, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x0E))
                    Store (TSR5, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x0F))
                    Store (TSR6, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x10))
                    Store (TSR7, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
                    Store (STB1, Index (OLRP, 0x11))
                    Store (TSR8, BF2S) /* \_SB_.WMID.WQBE.BF2S */
                    Store (BF2S, STB1) /* \_SB_.WMID.WQBE.STB1 */
            ...
            Method (WQBF, 1, NotSerialized)
            {
                ...
                If (LEqual (Local0, Zero))
                {
                    ...
                    Store (0x02, HWRC) /* \_SB_.WMID.HWRC */
                    Store (Zero, HWCT) /* \_SB_.WMID.HWCT */
                    Store (0xFA, HWBC) /* \_SB_.WMID.HWBC */
                    If (CondRefOf (\SSMP))
                    {
                        Store (0xD7, \SSMP) /* External reference */
                    }
